$(function(){
	/* 팝업연동 */
	if($.cookie('mypop')!='no_repeat') $('#popup').show();
	...
	//팝업
	if(is_opening) window.open("sub05/popup.html", "","resizable=no, toolbar=no, width=464, height=698");
	...
	$('#popup input').change(function(){
		if ($(this).is(':checked')) {
            $.cookie('mypop','no_repeat',{expires:1});
			console.log($.cookie('mypop'));
        }
        else {
            $.cookie('mypop','no_repeat',{expires:0});
			console.log($.cookie('mypop'));
        }
	})
